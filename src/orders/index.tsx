    ...
    return (
     ...
     <div className="table-responsive">
                     <table className="table-modern table-modern--fonts-md">
                        <thead>
                          <tr>
                            <th scope="col" className="text-center">شناسه سفارش</th>
                            ...
                            <th scope="col" className="text-center">وضعیت سفارش</th>
                            <th scope="col" className="text-center">وضعیت</th><th scope="col" className="text-center">وضعیت</th>
              ...
              <div className="card-body">
                <div className="table-responsive">
                  <table className="table-modern table-modern--fonts-md">
                    <thead>
                      <tr>
                        <th scope="col" className="text-center">نوع سفارش</th>
                        <th scope="col" className="text-center">بازار</th>
                        <th scope="col" className="text-center">مقدار</th>
                        <th scope="col" className="text-center">قیمت واحد</th>
                        <th scope="col" className="text-center">قیمت کل</th>
                        <th scope="col" className="text-center">پرشده</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
