  ...
  return (
    <CardBody className="text-center p-4">
      ...
      <p className="auth-tex mt-4 mb-4" style={{ fontSize: "14px" }}>
        متاسفانه در پرداخت شما : {data && `با کد رهیگیری ${data?.providerRef}`}{" "}
        مشکلی به وجود آمده است، در صورت کسر مبلغ از حساب بانکی شما تا ۷۲ ساعت
        کاری به صورت خودکار بازگردانده می&zwnj;شود.
      </p>
      <div className="text-center mt-4 mb-4">
