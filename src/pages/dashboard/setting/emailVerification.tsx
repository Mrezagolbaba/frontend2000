...
const EmailVerification = () => {
    ...
    return (
        <div>
            ...
            {step === 2 && <Step2 />}
            {step === 3 && (
                <div className="alert alert-success mb-5 mt-5">تایید هویت دو مرحله ای ایمیل با موفقیت فعال شد، در صورت تغییر ، مجددا مراحل را باید طی کنید. </div>
            )}
            {step !== 3 && <div className='d-flex justify-content-evenly mt-4 mb-4' style={{ width: '100%' }}>
