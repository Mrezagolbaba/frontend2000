                        ...
                        <div className="row mt-4">
                            <div className="col-lg-12">
                                <div className="d-flex justify-content-between align-items-center ">
                                    <label > </label>
                                    <a onClick={handleResendClick} style={{ color: '#335ffc',cursor:'pointer' }}>
                                        <span className="full-withraw mt-1" style={{ fontSize: '12px' }}>ارسال مجدد به موبایل</span>
                                    </a>
                                </div>
