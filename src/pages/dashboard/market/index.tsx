import { convertIRRToToman, convertTextSingle, extractLeftSide, rialToToman } from "helpers";
                ...
                <CardBody>
                    ...
                    <div className="table-responsive">
                        <table className="table-modern table table-borderless">
                            ...
                            <tbody>
                                {rates && rates.data.map((data) => (
                                    <tr>
                                        <td style={{ display: 'flex', alignItems: 'center', }}>
                                            <div style={{ marginRight: '10px' }}>
                                                <span className="text-50 m-fa">{convertTextSingle(extractLeftSide(data.pair))}
                                                </span>
                                            </div>
                                        </td>
                                        <td className="text-center">
                                            <div className="market-data">
                                                <span className="m-fa">{convertIRRToToman(data?.rate.substring(0, 5))}تومان
                                                </span>
                                            </div>
                                        </td>
                                        <td className="text-center">
                                        <div className="market-data">
                                            <a href="/dashboard/buy-sell" className="btn-simple tm__actions">شروع معامله</a>
                                        </div>
                                    </td>
                                    </tr>
                                ))}
