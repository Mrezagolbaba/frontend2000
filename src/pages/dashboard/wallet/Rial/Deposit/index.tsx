        ...
        {activeTab === "2" && data && data.length <= 0 && (
          <>
            <AlertWarning
              hasIcon
              text="
              کاربر گرامی؛ لطفاً با دقت به آدرس صفحه درگاه بانکی توجه فرمایید و تنها پس از اطمینان از ورود به سایت‌های سامانه شاپرک، اطلاعات کارت بانکی خود را وارد نمایید."
            />
            <AlertInfo
              hasIcon
