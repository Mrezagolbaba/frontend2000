        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="alert alert-success">
                در حال حاضر در هر ۲۴ ساعت می‌توانید مبلغ ۱۰۰ میلیون تومان (با دو
                کارت متفاوت) واریز نمایید.
              </div>
              <form className="modal-form">
                <div className="row">
                  <div className="col-lg-10">
        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="alert alert-success">
                با توجه به دستور بانک مرکزی، هر حساب در هر ۲۴ ساعت می‌تواند مبلغ
                ۱۰۰ میلیون تومان برداشت کند در صورت برداشت مبالغ بیشتر حساب‌های
                بیشتر خود را به آرسونیکس معرفی کنید.
              </div>
              <form className="modal-form">
                <div className="row">
                  <div className="col-lg-10">
