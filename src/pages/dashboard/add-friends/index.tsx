...
import { Col, Row, Card, CardHeader, CardBody, FormGroup, Label } from "reactstrap";
import { FaUsers, FaWallet } from "react-icons/fa";
import CopyInput from "components/Input/CopyInput";
import moment from "jalali-moment";
import { useGetFriendsListQuery, useGetReferralCodeQuery } from "store/api/addFriends";
interface IReferral {
  code: string;
  isDefault: boolean;
  userId: string;
              ...
              <Col xs={6} md={6}>
                <div className="d-flex justify-content-center items-center">
                  <div className="" >
                    ...
                    <div className="border p-4 rounded mt-2 " style={{ width: "130px" }}>
                      <span className="d-flex justify-content-center items-center">
                        <FaWallet size={50} color="gray" />
                      </span>
                      <h6 className="text-center mt-2">{data?.friendsFeePercent} تومان</h6>
                    </div>
                  </div>
                  <div className="mx-5">
