          ...
          <Container>
            ...
            <div className={home["section-holder__title"]}>
              ...
              >
                ...
                عرصه، همواره نیاز به یک پلتفرم تک نرخی صرافی ارز دیجیتال در حالت
                معامله OTC احساس می‌شد. نبودن چنین امکانی می‌تواند برای
                معامله‌گران، در مبادله و تبادل ارزهای دیجیتال اختلافی چشم گیر در
                مبلغ نهایی ایجاد کند.
              </p>
            </div>
            <div
