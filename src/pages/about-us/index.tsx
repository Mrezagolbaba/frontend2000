            ...
            <div className={about.summary}>
              <div className={about.summary__card}>
                <div className={about["summary__card-body"]}>
                  <p className={about.summary__text}>آرسونیکس (هور تابان تبادل الکترونیک)، به عنوان اولین صرافی ارز دیجیتال در ایران با ارائه ویژگی ذکر شده، برای رفع نیاز این دسته از کاربران ارائه شده و با رفع این نیاز، امکان مبادله‌ی دارایی‌های دیجیتال به صورت تک نرخی را در اختیار کاربران گذاشته است.

آرسونیکس همچنین با فراهم آوردن امکان معامله برای افراد مقیم خارج از کشور پا به عرصه ظهور گذاشته و این قابلیت را به کاربران می‌دهد که به روش‌های مختلفی، از جمله تبدیل دارایی‌های خود در کشوری که در آن اقامت دارند (بصورت کاملا قانونی)، به تومان یا ارزهای دیجیتال از تغییرات بازار بهره‌مند شوند و دارایی‌های خود را بدون مشکل معامله کنند.
                  </p>
                </div>
              </div>
            </div>
