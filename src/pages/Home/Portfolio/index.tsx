import crypto from "assets/img/coins/icon_btc.png";
import icon1 from "assets/img/coins/icon_xrp.png";
import icon2 from "assets/img/coins/icon2.png";
import icon3 from "assets/img/coins/icon3.png";
import icon4 from "assets/img/coins/icon_usdt.png";
    ...
    <section className={styles.profitable_holder}>
      ...
      <section className={styles.profitable_section}>
        ...
        <div className={`${styles.profitable_banner} ${styles.box1}`}>
          <h3 className={`section_title ${styles.profitable_banner_title}`}>
            پرسودترین ارزها
            <br />
            در روز گذشته
          </h3>
