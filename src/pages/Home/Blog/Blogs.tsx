  ...
  const blogData = [
    {
      ...
      content:
        "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک چاپگرها و متون بلکه روزنامه و مجله در ستون سطر آنچنان که لازم است،",
      date: "29دی1402",
      author: "محمد محمدی",
    },
    {
  ...
  return (
    <section className={styles.blog_holder}>
      <div className={styles.blog_title_holder}>
        <h3 className={`section_title ${styles.blog_title}`}>
          آخرین مطالب وبلاگ آرسونیکس
        </h3>
